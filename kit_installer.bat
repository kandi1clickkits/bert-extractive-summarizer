...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/bert-extractive-summarizer/releases/download/0.9.0/bert-extractive-summarizer.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/bert-extractive-summarizer/raw/main/requirements.txt
SET REPO_NAME=Text_Summarizer.zip
SET EXTRACTED_REPO_DIR=bert-extractive-summarizer
SET NOTEBOOK_NAME=Terms-of-service-summarizer.ipynb
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
